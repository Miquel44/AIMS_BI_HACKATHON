...
# Environment files
ENVIRONMENT_PATH = pathlib.Path(os.path.abspath('env'))
ENVIRONTMENT_FILE_PATH = ENVIRONMENT_PATH.joinpath('.env')
TEMPORAL_ENVIRONTMENT_FILE_PATH = ENVIRONMENT_PATH.joinpath('temp.env')
